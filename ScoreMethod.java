...
//		배열
		...
		ScoreMethod.scorePrint(number, subject, students, score, avgs);
	}
//
	static void scorePrint(int number, String []subject, String []students, int [][]score, float []avgs) {
		//입력함수 호출
	...
	static float avg(int total) {
		float avgScore = (float) (total/3.0);
		return avgScore;
	}
	//출력함수 - 이름
